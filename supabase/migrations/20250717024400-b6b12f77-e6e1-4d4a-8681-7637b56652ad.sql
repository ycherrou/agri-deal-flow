-- Supprimer complètement l'ancienne fonction et en créer une nouvelle
DROP FUNCTION IF EXISTS public.get_contract_size(product_type);
DROP FUNCTION IF EXISTS public.get_contract_size(text);

-- Créer la fonction avec un cast explicite pour éviter les conflits de types
...
-- Mettre à jour la fonction accept_bid_and_create_transaction pour utiliser un cast explicite
