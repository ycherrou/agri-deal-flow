-- Complete RLS rebuild - remove all recursive functions and policies

-- 1. Drop the problematic function
DROP FUNCTION IF EXISTS public.is_admin(uuid);

-- 2. Drop ALL policies on all tables to start completely fresh
...
-- 3. Create ultra-simple policies that cannot cause recursion
