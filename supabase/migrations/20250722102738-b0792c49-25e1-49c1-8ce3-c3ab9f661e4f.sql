-- Corriger la fonction accept_bid_and_create_transaction pour préserver le type de deal original
...
-- Corriger la vente existante #3ca32584 pour qu'elle soit en prime comme prévu
UPDATE ventes 
SET 
  type_deal = 'prime',
  prime_vente = 75.00,
  prix_flat = NULL,
  updated_at = now()
WHERE id = '3ca32584-b139-42dc-af13-2d8cbee6076d';